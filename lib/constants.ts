...
export const PHX_HTTP_PROTOCOL = process.env.NEXT_PUBLIC_HTTP_PROTOCOL || 'http://';  // Default to 'http' if not set
export const PHX_ENDPOINT = process.env.NEXT_PUBLIC_ENDPOINT || 'localhost:4009';  // Default to localhost if not set

// Cookie Names
export const PHX_COOKIE = 'lib_cookie';  // Could make this environment-dependent if necessary
